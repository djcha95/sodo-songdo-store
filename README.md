...
5.  **재고 및 현장 판매 관리**
    * **동작:** 관리자가 그룹 상품의 재고를 효율적으로 관리하는 기능입니다. '하위 상품 그룹' 단위로 **'그룹 총 재고'**를 한 번만 입력하면, '1개', '1박스' 등 하위 판매 옵션들이 이 총 재고를 함께 공유하며 차감되는 방식으로 동작하여 재고 관리의 정확성과 편의성을 높였습니다.
    * **핵심 파일:** `ProductAddAdminPage.tsx`, `SalesRoundEditPage.tsx`, `firebase.ts`
